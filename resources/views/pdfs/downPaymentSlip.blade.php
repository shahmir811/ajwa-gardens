            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000">{{ $allotment->registration_no }}</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000">{{ $allotment->customer->name }}</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000; width: 150px;">{{ number_format($allotment->down_amount) }} /-</td>
                        <td style="width:54px ;"><strong>Inwords</strong></td>
                        <td style="border-bottom:1px solid #000000">{{ $allotment->convertNumber($allotment->down_amount) }} Only</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000; width:350px;">{{ $allotment->down_payment_mode }}</td>
                        ...
                        <td style="border-bottom:1px solid #000000">{{ date('d/m/Y', strtotime($allotment->created_at)) }}</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000; width: 300px;">{{ $allotment->plot->plot_no }} (Phase: {{ $allotment->plot->phase->name }})</td>
                        <td style="width:30px;"><strong>Size</strong></td>
                        <td style="border-bottom:1px solid #000000">{{ $allotment->plot->marla }}-M ({{ $allotment->plot->type }})</td>
                    </tr>
                </table>
            </td>
        </tr>
