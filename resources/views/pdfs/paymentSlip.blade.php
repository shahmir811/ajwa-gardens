            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000; text-align: left; padding-left: 25px;">{{ $schedule->allotment->registration_no }}</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000; text-align: left; padding-left: 25px;">	{{ $schedule->allotment->customer->name }}</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000; width: 150px; text-align: left; padding-left: 25px;">	{{ number_format($schedule->amount_received) }} /-
                        <td style="width:64px ;"><strong>Inwords</strong></td>
                        <td style="border-bottom:1px solid #000000; text-align: left; padding-left: 25px;">{{ $schedule->convertNumber($schedule->amount_received) }} Only</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000; width: 300px;  text-align: left; padding-left: 25px;">{{ $schedule->allotment->plot->plot_no }} (Phase: {{ $schedule->allotment->plot->phase->name }})</td>
                        <td style="width:30px;"><strong>Size</strong></td>
                        <td style="border-bottom:1px solid #000000;  text-align: left; padding-left: 25px;">{{ $schedule->allotment->plot->marla }}-M ({{ $schedule->allotment->plot->type }})</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="100%" style="border-spacing:0; margin: 0 auto;">
                    <tr>
                        ...
                        <td style="border-bottom:1px solid #000000; width: 330px; text-align: left; padding-left: 25px;"></td>
